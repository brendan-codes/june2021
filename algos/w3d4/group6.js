...
class DLList {
    ...
    exists(val) {
        var searchFront = this.head;
        var searchBack = this.tail;
        if (searchFront == null) {
            return false;
        }
        if (searchFront.data == val || searchBack.data == val) {
            return true;
        }
        while ( searchFront.data != val || searchBack.data != val ) {
            searchFront = searchFront.next;
            searchBack = searchBack.prev;
            if ( searchFront.data == val ) {
                return true;
            }
            if ( searchBack.data == val ) {
                return true;
            }
